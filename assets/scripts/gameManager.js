...
let gameManager = {
    ...
    setFight: function() {
        ...
        getHeader.innerHTML = `
            <h3 id="scoreboard" class="game-fight-heading">Instructions</h3>
                <p id="scoreboard1" class="game-instruction">- To play, hit the buttons at the bottom of your screen.</p>
                <p id="scoreboard2" class="game-instruction">- Hit ATTACK to initiate an exchange with your opponent.</p>
                <p id="scoreboard3" class="game-instruction">- Hit RETREAT to take a breather and regain health points, 
                but beware: You could trip and fall!</p>
                <p id="scoreboard4" class="game-instruction">- If you get desperate, hit GO NUCLEAR. You will summon 
                enough godly power to end your opponent with one almighty blow, but beware: There is a 50 per cent 
                chance you will lose control and blow yourself up!</p>
                <p id="scoreboard5" class="game-instruction">- Keep your eye on the scoreboard here and 
                keep hitting buttons till either you or your opponent winds up in Valhalla!</p>`;
        getActions.innerHTML = `
        <section class="actions container-fluid"><div class="row"><div class="col-sm-12 text-center"><a href="#" class="btn btn-success btn-lg fight-btn" onclick="PlayerMoves.calcAttack(); scoreboard();">Attack!</a></div></div></section>
        <section class="actions container-fluid"><div class="row"><div class="col-sm-12 text-center"><a href="#" class="btn btn-secondary btn-lg fight-btn" onclick="retreat(); scoreboard();">Retreat!</a></div></div></section>
        <section class="actions container-fluid"><div class="row"><div class="col-sm-12 text-center"><a href="#" class="btn btn-danger btn-lg fight-btn" onclick="nuclearOption(); scoreboard();">Go nuclear!</a></div></div></section>`;
